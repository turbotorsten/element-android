...
internal fun CurrentStateEventEntity.Companion.whereRoomId(realm: Realm,
                                                           roomId: String): RealmQuery<CurrentStateEventEntity> {
...
internal fun CurrentStateEventEntity.Companion.whereType(realm: Realm,
    ...
    return whereRoomId(realm = realm, roomId)
